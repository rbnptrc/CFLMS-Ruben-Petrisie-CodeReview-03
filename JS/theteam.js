...
let teamMembers = [{
        ...
        post: "Director",
        email: "roy@index.com",
        image: src = "img/Cf_dummy_profile_image-1.jpg",
    ...
    },
    {
        ...
        image: "img/Cf_dummy_profile_image-2.jpg",
    ...
    },
    {
        ...
        image: "img/Cf_dummy_profile_image-3.jpg",
...
for (i = 0; i < teamMembers.length; i++) {
    ...
    tableDataImage.src = `${teamMembers[i].image}`;
    ...
    //also click image to show additional info = quote
    teamInfo.setAttribute("onclick", `showQuote('${teamMembers[i].image}')`);
